...
exports.rootClasses = rootClasses;
/**
  * @privateRemarks
...
function rootClasses(sectionName, node) {
    var _a;
    var _b, _c, _d;
    var key = "".concat(node.props.type, "__").concat(sectionName);
    var semanticKey = "formkit-".concat(sectionName);
    var familyKey = node.props.family ? "family:".concat(node.props.family, "__").concat(sectionName) : '';
    var memoKey = "".concat(key, "__").concat(familyKey);
    if (!(memoKey in classes)) {
        var sectionClasses = (_c = (_b = classes[key]) !== null && _b !== void 0 ? _b : globals[sectionName]) !== null && _c !== void 0 ? _c : {};
        sectionClasses[semanticKey] = true;
        if (familyKey in classes) {
            classes[memoKey] = __assign(__assign({}, classes[familyKey]), sectionClasses);
        }
        else {
            classes[memoKey] = sectionClasses;
        }
    }
    return (_d = classes[memoKey]) !== null && _d !== void 0 ? _d : (_a = {}, _a[semanticKey] = true, _a);
}
/**
